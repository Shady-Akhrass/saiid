...
const StudntForm = ({ formData, handleChange }) => {
  ...
  return (
    <div className="aids-form">
      <h2 className="text-2xl font-semibold mb-4">بيانات الطالب</h2>
      <div className="mb-4 ">
      ...
      <div className="mb-4">
        <label className="block text-gray-700"> اختيار المرحلة الدراسية  </label>
        <select
          name="academic_stage"
          value={formData.academic_stage}
          onChange={handleFieldChange}
          className={`mt-1 p-2 border ${
            errors.academic_stage ? "border-red-500" : "border-gray-300"
          } rounded-lg w-full`}
          required
        >
          <option value="">المرحلة الدراسية</option>
         
          <option value="الابتدائية">المرحلة الإبتدائية</option>
          <option value="الاعدادية">المرحلة الإعدادية</option>
          
        </select>
        {errors.academic_stage && (
          <span className="text-red-500">{errors.academic_stage}</span>
        )}
      </div>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          onChange={handleFieldChange}
          className={`mt-1 p-2 border ${
            errors.address_details ? "border-red-500" : "border-gray-300"
          } rounded-lg w-full`}
        />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={handleFieldChange}
          className={`mt-1 p-2 border ${
            errors.guardian_phone_number ? "border-red-500" : "border-gray-300"
          } rounded-lg w-full`}
          required
        />
