-- =====================================================
-- SQL Script: إضافة نظام المستفيدين للمشاريع (نسخة مبسطة)
-- التاريخ: 2025-12-28
...
ADD COLUMN `beneficiaries_excel_file` VARCHAR(255) NULL COMMENT 'مسار ملف Excel للمستفيدين' AFTER `notes_image`;
