-- ============================================
-- ملف SQL للتغييرات على قاعدة البيانات من 20-11-2025
...
-- ملاحظة: التحقق من وجود الأعمدة قبل إضافتها
-- --------------------------------------------------------
...
-- جعل email و password nullable (إذا لم يكونا nullable بالفعل)
-- ملاحظة: هذا قد يفشل إذا كان هناك بيانات موجودة تتعارض مع NULL
...
-- ملاحظة: يجب التحقق يدوياً قبل الحذف
...
-- ملاحظات:
-- ============================================
-- 1. تم استخدام IF NOT EXISTS و IF EXISTS حيثما أمكن
-- 2. بعض الأوامر قد تحتاج إلى تعديل حسب إصدار MySQL
-- 3. تأكد من تشغيل هذا السكريبت على نسخة احتياطية أولاً
-- 4. تحقق من جميع Foreign Keys قبل التشغيل
-- ============================================
